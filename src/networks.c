...
/*flappie_matrix flipflop_guppy_transitions(const raw_table signal, float temperature, const guppy_model * net){
    ...
    flappie_matrix gruB1 = aes_grumod(gruB1in, net->gruB1_sW, NULL, 1);
    gruB1in = free_flappie_matrix(gruB1in);
    //  Second GRU layer
    flappie_matrix gruF2in = feedforward_linear(gruB1, net->gruF2_iW, net->gruF2_b, NULL);
    gruB1 = free_flappie_matrix(gruB1);
    //flappie_matrix gruF2 = grumod_forward(gruF2in, net->gruF2_sW, NULL);
    flappie_matrix gruF2 = aes_grumod(gruF2in, net->gruF2_sW, NULL, 0);
    gruF2in = free_flappie_matrix(gruF2in);
    //  Third GRU layer
    flappie_matrix gruB3in = feedforward_linear(gruF2, net->gruB3_iW, net->gruB3_b, NULL);
    gruF2 = free_flappie_matrix(gruF2);
    //flappie_matrix gruB3 = grumod_backward(gruB3in, net->gruB3_sW, NULL);
    flappie_matrix gruB3 = aes_grumod(gruB3in, net->gruB3_sW, NULL, 1);
    gruB3in = free_flappie_matrix(gruB3in);
    //  Fourth GRU layer
    flappie_matrix gruF4in = feedforward_linear(gruB3, net->gruF4_iW, net->gruF4_b, NULL);
    gruB3 = free_flappie_matrix(gruB3);
    //flappie_matrix gruF4 = grumod_forward(gruF4in, net->gruF4_sW, NULL);
    flappie_matrix gruF4 = aes_grumod(gruF4in, net->gruF4_sW, NULL, 0);
    gruF4in = free_flappie_matrix(gruF4in);
    //  Fifth GRU layer
    flappie_matrix gruB5in = feedforward_linear(gruF4, net->gruB5_iW, net->gruB5_b, NULL);
    gruF4 = free_flappie_matrix(gruF4);
    //flappie_matrix gruB5 = grumod_backward(gruB5in, net->gruB5_sW, NULL);
    flappie_matrix gruB5 = aes_grumod(gruB5in, net->gruB5_sW, NULL, 1);
    gruB5in = free_flappie_matrix(gruB5in);
...
flappie_matrix flipflop_guppy_transitions(const raw_table signal, float temperature, const guppy_model * net){
    ...
    flappie_matrix gruB1 = aes_grumod_linear_gpu_wrapper(gruB1in, net->gruB1_sW, NULL, 1, net->gruF2_iW, net->gruF2_b, 1 );
    //flappie_matrix gruB1 = aes_grumod_linear(gruB1in, net->gruB1_sW, NULL, 1, net->gruF2_iW, net->gruF2_b, 1 );
    gruB1in = free_flappie_matrix(gruB1in);

    flappie_matrix gruF2 = aes_grumod_linear_gpu_wrapper(gruB1, net->gruF2_sW, NULL, 0, net->gruB3_iW, net->gruB3_b, 2 );
    //flappie_matrix gruF2 = aes_grumod_linear(gruB1, net->gruF2_sW, NULL, 0, net->gruB3_iW, net->gruB3_b, 2 );
    gruB1 = free_flappie_matrix(gruB1);

    flappie_matrix gruB3 = aes_grumod_linear_gpu_wrapper(gruF2, net->gruB3_sW, NULL, 1, net->gruF4_iW, net->gruF4_b, 3);
    //flappie_matrix gruB3 = aes_grumod_linear(gruF2, net->gruB3_sW, NULL, 1, net->gruF4_iW, net->gruF4_b, 3);
    gruF2 = free_flappie_matrix(gruF2);

    flappie_matrix gruF4 = aes_grumod_linear_gpu_wrapper(gruB3, net->gruF4_sW, NULL, 0, net->gruB5_iW, net->gruB5_b, 4);
    //flappie_matrix gruF4 = aes_grumod_linear(gruB3, net->gruF4_sW, NULL, 0, net->gruB5_iW, net->gruB5_b, 4);
    gruB3 = free_flappie_matrix(gruB3);

    //flappie_matrix gruB5 = aes_grumod_linear(gruF4, net->gruB5_sW, NULL, 1, net->gruB5_iW, net->gruB5_b);
    flappie_matrix gruB5 = grumod_backward(gruF4, net->gruB5_sW, NULL);
