...
flappie_matrix aes_grumod( const_flappie_matrix X, const_flappie_matrix sW, flappie_matrix ostate, int backward) {
    RETURN_NULL_IF(NULL == X, NULL);
    assert(NULL != sW);
    ...
    for (int i = 1; i < N; i++) {
        ...
        // COMPUTE modifies ostate and X matrix
        {
                int M=768, N=256;
...
flappie_matrix aes_grumod_linear( const_flappie_matrix X, const_flappie_matrix sW, flappie_matrix ostate, int backward, const_flappie_matrix W, const_flappie_matrix b, int layer) {
    RETURN_NULL_IF(NULL == X, NULL);
    assert(NULL != sW);
...
aes_grumod_linear_cpu( const_flappie_matrix X, const_flappie_matrix sW, flappie_matrix ostate, int backward, const_flappie_matrix W, const_flappie_matrix b, int layer,
...
flappie_matrix aes_grumod_linear_gpu_wrapper( const_flappie_matrix X, const_flappie_matrix sW, flappie_matrix ostate, int backward, const_flappie_matrix W, const_flappie_matrix b, int layer) {
    ...
    //aes_grumod_linear_cpu(X,sW,ostate,backward,W,b,layer,Xnext, xColTmp, &xCol);
    //aes_grumod_linear_gpu(X,sW,ostate,backward,W,b,layer, Xnext, xColTmp, &xCol);
    aes_grumod_linear_cpu_gpu(X,sW,ostate,backward,W,b,layer,Xnext, xColTmp, &xCol);
